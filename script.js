...
// Scroll-driven avatar rotation and visibility with smooth interpolation
...
if (avatarContainer) {
  ...
  window.addEventListener("scroll", () => {
    ...
    // Fade out avatar when we approach the projects section on desktop
    if (projectsSection && window.innerWidth > 980) {
      const projectsOffset = projectsSection.offsetTop;
      if (scrollY >= projectsOffset - window.innerHeight * 0.75) {
